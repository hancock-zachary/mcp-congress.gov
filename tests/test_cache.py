...
def test_update_members_merges_fields(monkeypatch):
    """Richer data (chamber/district) is not overwritten by sparser bill-enrichment records."""
    existing = {
        "last_updated": "2025-01-01T00:00:00Z",
        "members": {
            "J000295": {"name": "Rep. Jane Smith", "party": "R", "state": "OH", "chamber": "House", "district": 7}
        },
    }
    ...
    # Sparse update from bill enrichment — no chamber/district
    cache_mod.update_members({"J000295": {"name": "Rep. Jane Smith", "party": "R", "state": "OH"}})

    assert saved["members"]["J000295"]["chamber"] == "House"
